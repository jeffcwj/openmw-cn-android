...
#include "../include/spdlog/cfg/env.h"   // support for loading levels from the environment variable
...
#include "../include/spdlog/sinks/callback_sink.h"
void callback_example() {
    // Create the logger
...
// Log a vector of numbers
    ...
    #include "../include/spdlog/fmt/ranges.h"
void vector_example() {
...
// stopwatch example
#include "../include/spdlog/stopwatch.h"
#include <thread>
void stopwatch_example() {
    spdlog::stopwatch sw;
...
#include "../include/spdlog/sinks/udp_sink.h"
void udp_example() {
...
#ifndef _WIN32
    #include "../include/spdlog/sinks/syslog_sink.h"
void syslog_example() {
